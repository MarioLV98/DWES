...
<html lang="en">
    ...
    <body>
        ...
        $valida = 0;
        /* $respuesta = ""; */
        $cuestionario = array(); //Declaracion de array
        ...
        if (!filter_has_var(INPUT_POST, 'enviar') || $error) {
            ...
            <form action="<?PHP echo $_SERVER['PHP_SELF']; ?>" id="formulario1" method="post">
                ...
                <div id="persona1">
                    ...
                    <input type="text" name="nombre[0]" value="<?PHP if (isset($_POST['nombre'][0])) {
            echo $_POST['nombre'][0];
        } ?>"><br /><br />
                    <?PHP echo $erroresCampos[0]['nombre']; ?>

                    <label for="apellido[0]">Apellido:</label><br />
                    <input type="text" name="apellido[0]" value="<?PHP if (isset($_POST['apellido'][0])) {
                    echo $_POST['apellido'][0];
                }; ?>"><br /><br />
    <?PHP echo $erroresCampos[0]['apellido']; ?>

                    <label for="altura[0]">Altura:</label><br />
                    <input type="text" name="altura[0]" value="<?PHP if (isset($_POST['altura'][0])) {
        echo $_POST['altura'][0];
    }; ?>"><br /><br />
                    ...
                    <input type="text" name="email[0]" value="<?PHP if (isset($_POST['email'][0])) {
                    echo $_POST['email'][0];
                }; ?>"><br /><br />
    <?PHP echo $erroresCampos[0]['email']; ?>
                    ...
                    <input type="date" name="fechanac[0]" value="<?PHP if (isset($_POST['fechanac'][0])) {
        echo $_POST['fechanac'][0];
    }; ?>"><br /><br />
                    ...
                    <input type="text" name="caballos[0]" value="<?PHP if (isset($_POST['caballos'][0])) {
                    echo $_POST['caballos'][0];
                }; ?>"><br /><br />
                    <?PHP echo $erroresCampos[0]['caballos']; ?>

                    <label for="url[0]">URL:</label><br />
                    <input type="text" name="url[0]" value="<?PHP if (isset($_POST['url'][0])) {
                        echo $_POST['url'][0];
                    }; ?>"><br /><br />
    <?PHP echo $erroresCampos[0]['url']; ?>
                ...
                <div id="persona2">
                    ...
                    <input type="text" name="nombre[1]" value="<?PHP if (isset($_POST['nombre'][1])) {
        echo $_POST['nombre'][1];
    }; ?>"><br /><br />
    <?PHP echo $erroresCampos[1]['nombre']; ?>

                    <label for="apellido[1]">Apellido:</label><br />
                    <input type="text" name="apellido[1]" value="<?PHP if (isset($_POST['apellido'][1])) {
        echo $_POST['apellido'][1];
    }; ?>"><br /><br />
                    <?PHP echo $erroresCampos[1]['apellido']; ?>

                    <label for="altura[1]">Altura:</label><br />
                    <input type="text" name="altura[1]" value="<?PHP if (isset($_POST['altura'][1])) {
                        echo $_POST['altura'][1];
                    }; ?>"><br /><br />
    ...
    <?PHP echo $erroresCampos[1]['sexo']; ?><br /><br />
                    ...
                    <input type="text" name="email[1]" value="<?PHP if (isset($_POST['email'][1])) {
        echo $_POST['email'][1];
    }; ?>"><br /><br />
                    <?PHP echo $erroresCampos[1]['email']; ?>

                    <label for="fechanac[1]">Fecha nacimiento:</label><br />
                    <input type="date" name="fechanac[1]" value="<?PHP if (isset($_POST['fechanac'][1])) {
                    echo $_POST['fechanac'][1];
                }; ?>"><br /><br />
    <?PHP echo $erroresCampos[1]['fechanac']; ?>
                    ...
                    <input type="text" name="caballos[1]" value="<?PHP if (isset($_POST['caballos'][1])) {
                        echo $_POST['caballos'][1];
                    }; ?>"><br /><br />
    <?PHP echo $erroresCampos[1]['caballos']; ?>

                    <label for="url[1]">URL:</label><br />
                    <input type="text" name="url[1]" value="<?PHP if (isset($_POST['url'][1])) {
        echo $_POST['url'][1];
    }; ?>"><br /><br />
                ...
                <div id="persona2">
                    ...
                    <input type="text" name="nombre[2]" value="<?PHP if (isset($_POST['nombre'][2])) {
                        echo $_POST['nombre'][2];
                    }; ?>"><br /><br />
                    <?PHP echo $erroresCampos[2]['nombre']; ?>

                    <label for="apellido[2]">Apellido:</label><br />
                    <input type="text" name="apellido[2]" value="<?PHP if (isset($_POST['apellido'][2])) {
                    echo $_POST['apellido'][2];
                }; ?>"><br /><br />
    <?PHP echo $erroresCampos[2]['apellido']; ?>

                    <label for="altura[2]">Altura:</label><br />
                    <input type="text" name="altura[2]" value="<?PHP if (isset($_POST['altura'][2])) {
        echo $_POST['altura'][2];
    }; ?>"><br /><br />
    <?PHP echo $erroresCampos[2]['altura']; ?>
            ...
            <?PHP echo $erroresCampos[2]['sexo']; ?><br /><br />
                    ...
                    <input type="text" name="email[2]" value="<?PHP if (isset($_POST['email'][2])) {
            echo $_POST['email'][2];
        }; ?>"><br /><br />
                <?PHP echo $erroresCampos[2]['email']; ?>

                    <label for="fechanac[2]">Fecha nacimiento:</label><br />
                    <input type="date" name="fechanac[2]" value="<?PHP if (isset($_POST['fechanac'][2])) {
                    echo $_POST['fechanac'][2];
                }; ?>"><br /><br />
                ...
                <?PHP echo $erroresCampos[2]['marca']; ?>
                    ...
                    <input type="text" name="caballos[2]" value="<?PHP if (isset($_POST['caballos'][2])) {
                echo $_POST['caballos'][2];
            }; ?>"><br /><br />
                <?PHP echo $erroresCampos[2]['caballos']; ?>

                    <label for="url[2]">URL:</label><br />
                    <input type="text" name="url[2]" value="<?PHP if (isset($_POST['url'][2])) {
                echo $_POST['url'][2];
            }; ?>"><br /><br />
