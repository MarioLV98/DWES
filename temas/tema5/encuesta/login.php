        ...
        if (filter_has_var(INPUT_POST, 'enviar')) { //SI SE PULSA EL BOTON DE ENVIAR SE REALIZARAN LAS VALIDACIONES
            ...
            if (!$res) { 
               ...
               try{
               $pass = $conexion->query("select contrasena from Usuarios where contrasena=\"" .hash('sha256',$_POST['contrasena']) . "\""); 
    ...
    <?php
    //EN EL CASO EN EL QUE TODO HAYA IDO COMPROBAMOS QUE EL USUARIO Y CONTRASEÑA SON CORRECTOS
} else {
    ...
    <body>
        ...
        <form action="<?PHP echo $_SERVER['PHP_SELF']; ?>" id="formulario1" method="post">
                ...
                <div id="encuesta">
                    ...
                    <img src="img/modeloDeDatos.PNG" alt="Funcionamiento"/>
                    <img src="img/encuesta2.PNG" alt="Almacenamiento"/>
                    <img src="img/modeloAlmacenamiento.PNG" alt=""/>
        <footer>
